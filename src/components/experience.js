  ...
  return (
    <div className={ExperienceStyles.wrapper}>
      <div className={ExperienceStyles.mainContainer}>
        ...
        <p> 
            Faute d'avoir pu trouver des financements pour terminer ce projet, j'ai rejoint un studio de jeux mobile crée par <strong>Voodoo</strong> appelé <strong>Ripe Groove Lab</strong> ayant pour ambition de développer des jeux <strong>Web3</strong>. 
